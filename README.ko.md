...
- 기본
  - [scala-tutorial](./scala-tutorial) - Scala 튜토리얼
...
다음과 같은 디렉토리와 파일이 프로젝트 디렉토리에 있습니다.
...
사용할 수 있습니다. 이 명령어는 프로젝트와 함께 Scala REPL을 실행합니다. 이
...
[블랙보드](https://kulms.korea.ac.kr/)를 사용하여 각 프로젝트의
`Implementation.scala`를 제출하세요.

> :warning: **기존에 존재하던 코드를 단순히 복사해서 제출하면 F를 받게 됩니다.**
> 각 프로젝트는 반드시 혼자서 구현해야 합니다. 강의 자료, 강의 슬라이드, 인터넷
