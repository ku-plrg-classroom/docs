# Scala 프로그램 과제 공용 지침서

[English](./scala.md) | [한국어](./scala.ko.md)

이 문서는 Scala 프로그래밍 과제에 대한 **공용 지침서**입니다. 과제를 시작하기
전에 다음 지침을 주의 깊게 읽어주세요.
...
> [!WARNING]
>
> `[assignment name]`을 **해당 과제 이름으로 바꿔주세요**. 혹은, 각 과제의
...
> [!WARNING]
>
> 주어진 테스트 케이스를 모두 통과한 것이 구현이 올바르다는 것을 보장하지는
