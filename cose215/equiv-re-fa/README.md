...
The second task is to implement the `reToENFA` function that converts a **regular
...
The third task is to implement the `dfaToRE` function that converts a
...
The first task is to implement the `enfaToDFA` function that converts an
